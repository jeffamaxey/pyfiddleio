...
class _TotalOrderingMixin(object):
    ...
    def __le__(self, other):
        ...
        return self.__eq__(other) if less is NotImplemented or not less else less
    ...
    def __gt__(self, other):
        ...
        equal = self.__eq__(other)
        return NotImplemented if equal is NotImplemented else not less and not equal
...
class _BaseV4(object):
    ...
    def _is_hostmask(self, ip_str):
        ...
        try:
            ...
            return False
        return False if len(parts) != len(bits) else parts[0] < parts[-1]
